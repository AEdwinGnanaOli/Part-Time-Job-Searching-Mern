            ...
            >
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    name="shopname"
                    className={errors.shopname && "regi-inp-err"}
                    {...register("shopname", {
                    ...
                    onChange={(e) =>
                      setUserData({ ...userData, shopname: e.target.value })
                    }
                  />
                  {errors.shopname && (
                    <div className="error-color">{errors.shopname.message}</div>
                  )}
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    disabled
                    name="email"
                    className={errors.email && "regi-inp-err"}
              ...
              >
                ...
                <Form.Control
                  ...
                  name="address"
                  className={errors.address && "regi-inp-err"}
                  {...register("address", {
                    required: "Address is Required"
                  })}
                  value={userData.shopaddress}
                  onChange={(e) =>
                    setUserData({ ...userData, shopaddress: e.target.value })
                  }
                />
                {errors.address && (
                  <div className="error-color">{errors.address.message}</div>
                )}
              </Form.Group>
              <Col>
                <Row>
                  <Form.Group as={Col} className="">
                    ...
                    <Form.Control
                      ...
                      name="starttime"
                      className={errors.starttime && "regi-inp-err"}
                      {...register("starttime", {
                  ...
                  <Form.Group as={Col} className="">
                    ...
                    <Form.Control
                      ...
                      placeholder="Enter working time"
                      name="endtime"
                      className={errors.endtime && "regi-inp-err"}
                      {...register("endtime", {
                        required: "StartTime is Required"
                      })}
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    name="price"
                    className={errors.price && "regi-inp-err"}
                    {...register("price", {
                  ...
                  />
                  {errors.price && (
                    <div className="error-color">{errors.price.message}</div>
                  )}
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="number"
                    placeholder="Enter The shop mobile number"
                    name="phone"
                    className={errors.phone && "regi-inp-err"}
                    {...register("phone", {
                      required: " Phone is Required"
                    })}
                    value={userData.shopmobilenumber}
                    onChange={(e) =>
                      setUserData({
                        ...userData,
                  ...
                  />
                  {errors.phone && (
                    <div className="error-color">{errors.phone.message}</div>
                  )}
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="text"
                    placeholder="what the work for your shop"
                    name="work"
                    className={errors.work && "regi-inp-err"}
                    {...register("work", {
                      required: "Work is Required"
                    })}
                    value={userData.work}
                    onChange={(e) =>
                      setUserData({ ...userData, work: e.target.value })
                    }
                  />
                  {errors.work && (
                    <div className="error-color">{errors.work.message}</div>
                  )}
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-3">
                  ...
                  />
                  {errors.image && (
                    <div className="error-color">{errors.image.message}</div>
                  )}
                </Form.Group>
              </Col>
