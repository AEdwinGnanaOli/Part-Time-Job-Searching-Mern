      ...
      axios
        ...
        .then((user) => {
          ...
          if (user.data.message === "User already exists") {
            ...
            navigate(
              `/vendorproductsign/${vendorId}`,
              sessionStorage.setItem("avemail", user.data.vendor.email)
            );
          }
        })
        .catch((err) => {
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="text"
                    name="name"
                    className={errors.name && "regi-inp-err"}
                    {...register("name", {
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    className={errors.password && "regi-inp-err"}
                    {...register("password", {
